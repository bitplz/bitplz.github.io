...
const S = {
  ...
  proxyUrl: 'https://fcc-8awv.onrender.com',
  authToken: 'freecc',
  systemPrompt: '',
  maxTokens: 8192,
  customModels: [],
...
function loadSettings() {
  ...
  S.proxyUrl          = s.proxyUrl     || 'https://fcc-8awv.onrender.com';
...
function saveSettings() {
  S.proxyUrl     = (document.getElementById('proxy-url').value || '').replace(/\/+$/, '') || 'https://fcc-8awv.onrender.com';
